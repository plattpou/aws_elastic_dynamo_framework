...
exports.ElasticSearchService = class ElasticSearchService {
    ...
    putDocument(indexName, doc, callback) {
        ...
        console.log("hitting es endpoint: ", "/" + indexName + "/" + mappingType + "/" + doc.id);

        try {

            //elastic 6 complains if you store the _id, therefore we replace it with just id, to be able to search on it still
