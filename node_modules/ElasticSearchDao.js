...
exports.ElasticSearchDao = class ElasticSearchDao {
    ...
    createIndex(indexName, docType, structure, callback) {
        ...
        let definition = this._generateIndexDefinition(docTypeLower,structure);
        let url = path.join('/', indexName, docTypeLower);
        console.log('Created ES Index ' + url,definition);
    ...
    deleteIndex(indexName, callback) {
        ...
        console.log('Deleted ES Index ' + url);
